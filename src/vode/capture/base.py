...
from vode.core import ComputationGraph, ExecutionNode
...
class BaseTracer(ABC):
    ...
    3. Return a ComputationGraph or ExecutionNode
    ...
    @abstractmethod
    def capture(self, *args: Any, **kwargs: Any) -> ComputationGraph | ExecutionNode:
        ...
        Returns:
            ComputationGraph or ExecutionNode with captured data
        """
        pass
